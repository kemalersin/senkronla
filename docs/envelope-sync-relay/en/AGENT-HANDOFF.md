...
> **Provide this file** to the implementation agent together with the entire `docs/envelope-sync-relay/en/` (or `tr/`) folder.
...
All design decisions are in `docs/envelope-sync-relay/en/` (English) or `docs/envelope-sync-relay/tr/` (Turkish). In case of conflict, priority:
...
If deviation is required, create `docs/DEVIATIONS.md` and justify it.
...
1. Read `docs/envelope-sync-relay/en/README.md` (or `tr/README.md`)
