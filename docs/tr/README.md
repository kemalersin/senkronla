...
| 16 | [16-APP-REGISTRY.md](./16-APP-REGISTRY.md) | **Uygulama kaydı, namespace–app bağlama (spec v1.3 — yayında)** |
| 17 | [17-OPERATOR-LIMIT-OVERRIDES.md](./17-OPERATOR-LIMIT-OVERRIDES.md) | **Operatör limit override — namespace / app / developer cascade (v1.3.2 — yayında)** |
...
**v1.3.0 (yayında):** Uygulama kaydı — operatör veya self-service app kaydı; namespace'ler app'lere bağlı — bkz. [16-APP-REGISTRY.md](./16-APP-REGISTRY.md).

**v1.3.2 (yayında):** Operatör limit override — namespace / app / developer cascade — bkz. [17-OPERATOR-LIMIT-OVERRIDES.md](./17-OPERATOR-LIMIT-OVERRIDES.md).

---

| Alan | Değer |
|------|--------|
| Spec sürümü | 1.3.1 yayında (app registry, çoklu döküman, WebSocket); 1.3.2 limit override |
